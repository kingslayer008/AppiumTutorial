...
public class BaseTest {
    ...
    {
        service = new AppiumServiceBuilder().withAppiumJS(new File("C:\\Users\\dines\\AppData\\Roaming\\npm\\node_modules\\appium\\build\\lib\\main.js"))
                .withIPAddress("127.0.0.1").usingPort(4723).build();
        service.start();
        UiAutomator2Options options = new UiAutomator2Options();
        options.setDeviceName("dineshphone");
        options.setApp("C:\\Users\\dines\\IdeaProjects\\untitled1\\src\\test\\java\\resources\\APKFiles.zip");
